...
const TentangKami = () => {
  return (
    <>
      <Navbar />
      <div>
        <h1 className="font-bold text-2x2" style={{ color: 'black', marginLeft: '7%', marginTop: '5%' }}>
          Laundry Ease
        </h1>
        ...
        <span style={{ color: 'white', textAlign: 'center',fontSize:'24pt' }}>Visi</span>
          </div>
          </div>
          ...
          <div className="d-flex" style={{ marginTop: "3%", marginLeft:'10%' }}>
            ...
            <Card.Img variant="bottom" src={cuci1} alt="Gambar" style={{ width: '50%', height: '50%' }} />
          </div>
        ...
        <span style={{ color: 'white', textAlign: 'center',fontSize:'24pt' }}>Misi</span>
          </div>
          </div>
          {/* bagian card misi*/}
          <div className="d-flex" style={{ marginTop: "3%", marginLeft:'10%' }}>
          <Card.Img variant="bottom" src={cuci2} alt="Gambar" style={{ width: '40%', height: '40%' }} />
            <Card
              style={{
                width: "40rem",
                height: "30rem",

...
const Newpass = () => {
  ...
  // Fungsi untuk mengupdate progres bar
  const updateProgress = () => {
    // Contoh peningkatan progres setiap detik
    let count = 0;
          ...
          <Card style={{width: '50rem', height: '60vh', background: '#D9EAF4', border: 'none', boxShadow: '0px -3px 4px grey', paddingTop: '80px'}}>
            <Card.Body>
              ...
              <div style={{display: 'flex', flexDirection: 'column', width: '80%', paddingLeft: '20%', paddingBottom: '40px', paddingTop: '20px'}}>
                <label className='flex justify-start'>Masukkan kata sandi baru Anda</label>
                <input style={{border:'1px solid', borderRadius: '10px', height: '40px'}} type="password" placeholder="Masukkan kata sandi baru" />
              </div>
              {/* Form untuk konfirmasi kata sandi */}
              <div style={{display: 'flex', flexDirection: 'column', width: '80%', paddingLeft: '20%', paddingBottom: '40px', paddingTop: '20px'}}>
                <label className='flex justify-start'>Konfirmasi kata sandi baru Anda</label>
                <input style={{border:'1px solid', borderRadius: '10px', height: '40px'}} type="password" placeholder="Konfirmasi kata sandi baru" />
              </div>
              {/* Tombol 'Selesai' */}
              <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
        <ProgressBar now={progress} style={{ width: '50%', marginBottom: '20px' }} />
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <Link to='/Login-pelanggan'>

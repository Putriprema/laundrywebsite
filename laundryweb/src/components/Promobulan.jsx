...
const Promobulan = () => {
  ...
  return (
    <div>
      <h1 data-aos="fade-up" className=" justify-center text-center font-bold text-[300px]" style={{ color: 'black', fontSize: '24pt',  marginTop: '200px', marginBottom: '100px'}}>Dapatkan Promo Bulan Ini!</h1>
